...
const About = () => {
  return (
    <section id="about" className="py-24 relative bg-kh-bg-primary transition-colors duration-300 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <motion.div 
            className="lg:col-span-2 space-y-6 text-kh-muted text-base md:text-lg leading-relaxed font-medium text-left"
          ...
          >
            <p>
              ¡Hola! Mi nombre es <strong className="text-kh-text font-extrabold">Joel Barreira</strong> y soy un profesional apasionado por fusionar el desarrollo de software moderno con la administración de sistemas informáticos complejos.
            </p>
            <p>
            ...
            <p>
              A lo largo de mi trayectoria he colaborado en entornos exigentes como la multinacional <strong className="text-kh-text font-semibold">NTT DATA</strong> y el <strong className="text-kh-text font-semibold">Ayuntamiento de Alicante</strong>. En estas posiciones he implementado soluciones robustas y consolidado habilidades de <strong className="text-kh-text font-semibold">automatización de procesos mediante RPA</strong> (UiPath, Blue Prism, Camunda), eliminando cuellos de botella operativos y optimizando flujos corporativos bajo metodologías ágiles como Scrum.
            </p>
            <p>
          ...
          <div className="space-y-6">
            ...
            <motion.div 
              ...
              className="p-8 rounded-3xl bg-kh-bg-card border border-kh-border hover:border-accent-500/40 dark:hover:border-accent-500/40 shadow-xl hover:shadow-2xl hover:shadow-accent-500/5 dark:hover:shadow-accent-500/10 transition-all duration-300 relative overflow-hidden group text-left"
            >
              ...
              <h3 className="text-kh-text font-black text-xl mb-2 flex items-center gap-2">
                Desarrollo Software
              </h3>
              <p className="text-kh-muted text-sm font-semibold leading-relaxed">
